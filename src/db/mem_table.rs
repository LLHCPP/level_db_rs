...
use crate::util::coding::{encode_fixed64, encode_varint32, encode_varint64, get_varint32ptr, varint_length};
...
impl MemTable {
    fn add(&self, seq: u64, value_type: ValueType, key: &Slice, value: &Slice) {
       ...
       let buf =  self.arena.alloc_array::<u8>(encode_len);
        ...
        self.table.insert(key.clone(), (seq, value_type, Slice::new_from_ptr(buf)));
    }
